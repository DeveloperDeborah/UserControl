...
public class EssentialsImport extends RunsafeConsoleCommand
{
	public EssentialsImport(IDatabase db, IScheduler scheduler, IOutput output)
	{
		super("essentialsimport");
		database = db;
